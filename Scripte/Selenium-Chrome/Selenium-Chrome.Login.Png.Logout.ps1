...
try
 {
  ...
  #
  Write-Verbose -Message ('Window Position/Size abgeschlossen');
  #
 }
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei Window Position/Size');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
try
...
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei Navigate');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
try
 {
  #
  $Action = $Null;
  $Action = $Browser.FindElement([OpenQA.Selenium.By]::Id('username'));
  $Action.SendKeys($Benutzer);
  #
  Write-Verbose -Message ('FindElement/SendKeys angeschlossen');
  #
 }
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei FindElement/SendKeys');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
try
 {
  #
  $Action = $Null;
  $Action = $Browser.FindElement([OpenQA.Selenium.By]::Id('password'));
  $Action.SendKeys($Passwort);
  #
  Write-Verbose -Message ('FindElement/SendKeys angeschlossen');
  #
 }
...
try
 {
  #
  $Action = $Null;
  $Action = $Browser.FindElement([OpenQA.Selenium.By]::Id('submit'));
  $Action.Click();
  #
  Write-Verbose -Message ('FindElement/Click angeschlossen');
  #
 }
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei FindElement/Click');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
try
 {
  ...
  $Screenshot.SaveAsFile($WorkingDir+'\Bild.png', $ImageFormat)
  #
  Write-Verbose -Message ('Screenshot abgeschlossen');
  #
 }
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei Screenshot');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
try
 {
  #
  $Action = $Null;
  $Action = $Browser.FindElement([OpenQA.Selenium.By]::XPath("/html/body/div/div/section/div/div/article/div[2]/div/div/div/a"));
  $Action.Click();
  #
  Write-Verbose -Message ('FindElement/Click menubar abgeschlossen');
  #
 }
catch
 {
  ...
  if($_.Exception.Message)               { [String]$Message          = $('Message: '+$_.Exception.Message);                 };
  #
  Write-Warning -Message ($ScriptLineNumber+$Category+' Fehler bei FindElement/Click menubar');
  Write-Warning -Message ($Message);
  #
  $Browser.Quit();
  #
...
#
Remove-Variable -Name Benutzer;
Remove-Variable -Name Passwort;
#